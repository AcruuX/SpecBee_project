...
(function ($, Drupal, once) {
  ...
  $(document).ready(function() {
    $("div.con-card-wrapper").hover(function() {
      $(this).siblings(".con-card-image-wrapper").addClass("imagehover");
      }, function() {
      $(this).siblings(".con-card-image-wrapper").removeClass("imagehover");
    });
  });
